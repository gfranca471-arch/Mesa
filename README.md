...
Mesa virtual completa para jogar RPG com seus amigos, com **dados 3D realistas**, **videochamada**, **sincronização em tempo real** e **fichas por sistema**.
...
| 📋 **Fichas** | Fichas próprias para Lobisomem, Vampiro e D&D 5E (1 sistema por sala) |
...
2. O código da sala é gerado automaticamente
3. **Jogadores** acessam, escolhem "Jogador", digitam o código e a senha
4. Todos entram na mesa com videochamada, dados 3D, fichas e chat sincronizados!
